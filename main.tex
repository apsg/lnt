...
%\draw (current page.center) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Leave No Trace\\[15pt] % Book title
%{\Large Podręcznik}\\[20pt] % Subtitle
%{\huge hm. dr inż. Szymon Gackowski}}}; % Author name
%\end{tikzpicture}
%\vfill
%\endgroup

\includepdf{Pictures/okladka.pdf}
...
\part{7 Zasad Leave No Trace}\index{7-zasad}

%----------------------------------------------------------------------------------------
%	CHAPTER 1
%----------------------------------------------------------------------------------------

\include{zasady/1-planuj}
...
\lipsum
\begin{wrapfigure}{lt}{0.7\textwidth}
	\begin{center}
